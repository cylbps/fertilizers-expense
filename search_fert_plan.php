...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    include "search_fert_plan_form.php";
    ...
    if(isset($_POST['culture'])) {
        $cultureID = $commonFunctions->clearData($_POST['culture']);
    }else {
        $cultureID = NULL;
    }
    ...
    $fertilizerPlansArr = $fertilizePlans->searchFertPlan($cultureID, $fertilizerID);
