...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <h2>Найти план расхода</h2>
            <form name="new_fert_plan_form_exp" class="fert-plan-form" method="post" action="search_fert_plan.php">
                <table>                         
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="fert-plan-form-input"><input type="submit" value="Найти" class="search-fert-plan-btn">&nbsp;
